          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                ...
                <img src="/rhino-1.png" className="w-full" />
              </div>
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a{" "}
                <span className="bg-gray-500 px-2 text-white">Custom</span>{" "}
                Phone Case
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Unleash your creativity and protect your phone in style with our
                fully{" "}
                <span className="font-semibold">customizable phone cases.</span>{" "}
                Whether you're looking to showcase your favorite photos, unique
                artwork, or a special message, we've got you covered.
              </p>
              ...
              <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                <div className="space-y-2">
                  ...
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-green-400" />5 year
                    print gurantee
                  </li>
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-green-400" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
              ...
              <span className="relative px-2">
                customers{" "}
                <Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-gray-500" />
              </span>{" "}
              say
            </h2>
            <img src="/rhino-2.png" className="w-24 order-0 lg:order-2" alt="" />
          </div>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='flex gap-4 mt-2'>
                ...
                />
                <div className='flex flex-col'>
                  <p className='font-semibold'>Bhushan</p>
                  <div className='flex gap-1.5 items-center text-zinc-600'>
                    <Check className='h-4 w-4 stroke-[3px] text-green-600' />
                    <p className='text-sm'>Verified Purchase</p>
                  </div>
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            ...
            <h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
                ...
                <span className='relative px-2 bg-gray-500 text-white'>
                  your own case
                </span>{' '}
                now
              </h2>
